...
namespace Crystalbyte.Paranoia {
    ...
    public sealed class VirtualFileDataObject : IDataObject, IAsyncOperation {
        ...
        ///     A FORMATETC structure that defines the format, target device, aspect, and medium that will be
        ...
        ///     A pointer to the IAdviseSink interface on the advisory sink that will receive the change
        ///     notification.
        /// </param>
        ...
        ///     When this method returns, contains an IEnumSTATDATA that receives the interface pointer to the
        ...
        /// </summary>
        /// <param name="formatIn">
        ///     A pointer to a FORMATETC structure that defines the format, medium, and target device that the
        ///     caller would like to use to retrieve data in a subsequent call such as GetData.
        /// </param>
        /// <param name="formatOut">
        ///     When this method returns, contains a pointer to a FORMATETC structure that contains the most
        ///     general information possible for a specific rendering, making it canonically equivalent to formatetIn.
        /// </param>
        /// <returns>HRESULT success code.</returns>
        ...
        /// </summary>
        /// <param name="format">
        ///     A pointer to a FORMATETC structure that defines the format, medium, and target device to use when
        ///     passing the data.
        /// </param>
        /// <param name="medium">
        ///     When this method returns, contains a pointer to the STGMEDIUM structure that indicates the storage
        ///     medium containing the returned data through its tymed member, and the responsibility for releasing the medium
        ...
        /// </summary>
        /// <param name="format">
        ///     A pointer to a FORMATETC structure that defines the format, medium, and target device to use for
        ///     the query.
        /// </param>
        /// <returns>HRESULT success code.</returns>
        ...
        /// </summary>
        /// <param name="formatIn">
        ///     A FORMATETC structure that defines the format used by the data object when interpreting the data
        ...
        /// <param name="release">
        ///     true to specify that the data object called, which implements SetData, owns the storage medium
        ...
        ///     A Boolean value that is set to VARIANT_TRUE to indicate that an asynchronous operation is
        ///     supported, or VARIANT_FALSE otherwise.
        /// </param>
        ...
        ///     Set to VARIANT_TRUE if data extraction is being handled asynchronously, or VARIANT_FALSE
        ///     otherwise.
        /// </param>
        ...
        /// </summary>
        /// <param name="hResult">
        ///     An HRESULT value that indicates the outcome of the data extraction. Set to S_OK if successful, or
        ///     a COM error code otherwise.
        /// </param>
        /// <param name="pbcReserved">Reserved. Set to NULL.</param>
        /// <param name="dwEffects">
        ///     A DROPEFFECT value that indicates the result of an optimized move. This should be the same
        ///     value that would be passed to the data object as a CFSTR_PERFORMEDDROPEFFECT format with a normal data extraction
        ///     operation.
        /// </param>
        ...
        ///     One of the DragDropEffects values that specifies permitted effects of the drag-and-drop
        ///     operation.
        /// </param>
        /// <returns>
        ///     One of the DragDropEffects values that specifies the final effect that was performed during the drag-and-drop
        ///     operation.
        /// </returns>
        /// <remarks>
        ...
        public static DragDropEffects DoDragDrop(DependencyObject dragSource, IDataObject dataObject,
        ...
        /// <summary>
        ///     Contains the methods for generating visual feedback to the end user and for canceling or completing the
        ...
        private class DropSource : NativeMethods.IDropSource {
            ...
            ///     QueryContinueDrag or to DoDragDrop if this is the first call to QueryContinueDrag. A TRUE value indicates the end
            ///     user has pressed the escape key; a FALSE value indicates it has not been pressed.
            /// </param>
            ...
            /// </summary>
            /// <param name="dwEffect">
            ///     The DROPEFFECT value returned by the most recent call to IDropTarget::DragEnter,
