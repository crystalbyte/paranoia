...
namespace Crystalbyte.Paranoia.UI {
    ...
    internal sealed class WatermarkAdorner : Adorner {
        ...
        private void OnContentPresenterSizeChanged(object sender, SizeChangedEventArgs e) {
            var left = Control.Margin.Left + Control.Padding.Left + 3;
            _contentPresenter.Margin = new Thickness(left, 0, 0, 0);
        }
        ...
        /// </summary>
        /// <param name="index"> A 32-bit signed integer that represents the index value of the child <see cref="Visual" /> . The value of index must be between 0 and <see
        ///    cref="VisualChildrenCount" /> - 1. </param>
