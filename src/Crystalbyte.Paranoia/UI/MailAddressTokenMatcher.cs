...
namespace Crystalbyte.Paranoia.UI {
    public sealed class MailAddressTokenMatcher : ITokenMatcher {
        ...
        private const string MailAddressPattern = @"[A-Za-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[A-Za-z0-9](?:[A-Za-z0-9-]*[A-Za-z0-9])?\.)+(?:[A-Zaa-z]{2}|com|org|net|edu|gov|mil|biz|info|mobi|name|aero|asia|jobs|museum)\b";
