...
namespace Crystalbyte.Paranoia.Contexts {
    public sealed class MessageContext : NotificationObject, IHtmlSource {
        ...
        public MessageContext(ImapAccountContext account, ImapEnvelope envelope, string mailbox) {
            _envelope = envelope;
            _account = account;
            _mailbox = mailbox;
        }
        ...
        /// </summary>
        public string Key {
            get { return string.Format("{0}@{1}:{2}", _account.ImapUsername, _account.Host, _mailbox); }
        }
