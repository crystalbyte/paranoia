...
(function () {
 ...
 For licensing, see LICENSE.md or http://ckeditor.com/license
*/
    CKEDITOR.skin.name = "moono-dark"; CKEDITOR.skin.ua_editor = "ie,iequirks,ie7,ie8,gecko"; CKEDITOR.skin.ua_dialog = "ie,iequirks,ie7,ie8"; CKEDITOR.plugins.add("basicstyles", {
        init: function (c) {
    ...
    CKEDITOR.plugins.add("dialog", { requires: "dialogui", init: function (t) { t.on("doubleclick", function (u) { u.data.dialog && t.openDialog(u.data.dialog) }, null, null, 999) } }); (function () {
        function v(b) {
            function a() {
    ...
    CKEDITOR.dom.element.prototype.focusPrevious = function (i, h) { for (var g = void 0 === h ? this.getTabIndex() : h, f, c, d, e = 0, b, a = this.getDocument().getBody().getLast() ; a = a.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT) ;) { if (!f) if (!c && a.equals(this)) { if (c = !0, i) { if (!(a = a.getPreviousSourceNode(!0, CKEDITOR.NODE_ELEMENT))) break; f = 1 } } else c && !this.contains(a) && (f = 1); if (a.isVisible() && !(0 > (b = a.getTabIndex()))) if (0 >= g) { if (f && 0 === b) { d = a; break } b > e && (d = a, e = b) } else { if (f && b == g) { d = a; break } if (b < g && (!d || b > e)) d = a, e = b } } d && d.focus() }; (function () {
    ...
    CKEDITOR.UI_PANELBUTTON = "panelbutton"; CKEDITOR.plugins.add("colorbutton", {
    ...
    CKEDITOR.config.colorButton_backStyle = { element: "span", styles: { "background-color": "#(color)" } }; CKEDITOR.config.plugins = 'basicstyles,blockquote,dialogui,dialog,clipboard,panel,floatpanel,menu,contextmenu,button,toolbar,elementspath,enterkey,popup,filebrowser,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,pastetext,removeformat,sourcearea,specialchar,stylescombo,tab,undo,font,panelbutton,colorbutton'; CKEDITOR.config.skin = 'moono-dark'; (function () { var setIcons = function (icons, strip) { var path = CKEDITOR.getUrl('plugins/' + strip); icons = icons.split(','); for (var i = 0; i < icons.length; i++) CKEDITOR.skin.icons[icons[i]] = { path: path, offset: -icons[++i], bgsize: icons[++i] }; }; if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,horizontalrule,312,,image,336,,indent-rtl,360,,indent,384,,outdent-rtl,408,,outdent,432,,anchor-rtl,456,,anchor,480,,link,504,,unlink,528,,bulletedlist-rtl,552,,bulletedlist,576,,numberedlist-rtl,600,,numberedlist,624,,pastetext-rtl,648,,pastetext,672,,removeformat,696,,source-rtl,720,,source,744,,specialchar,768,,redo-rtl,792,,redo,816,,undo-rtl,840,,undo,864,,bgcolor,888,,textcolor,912,', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,horizontalrule,312,auto,image,336,auto,indent-rtl,360,auto,indent,384,auto,outdent-rtl,408,auto,outdent,432,auto,anchor-rtl,456,auto,anchor,480,auto,link,504,auto,unlink,528,auto,bulletedlist-rtl,552,auto,bulletedlist,576,auto,numberedlist-rtl,600,auto,numberedlist,624,auto,pastetext-rtl,648,auto,pastetext,672,auto,removeformat,696,auto,source-rtl,720,auto,source,744,auto,specialchar,768,auto,redo-rtl,792,auto,redo,816,auto,undo-rtl,840,auto,undo,864,auto,bgcolor,888,auto,textcolor,912,auto', 'icons.png'); })(); CKEDITOR.lang.languages = { "en": 1, "de": 1 };
}());