...
namespace Crystalbyte.Paranoia.Cef {
    ...
    public static class CefV8Capi {
        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8context_get_current_context",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8contextGetCurrentContext();

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8context_get_entered_context",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8contextGetEnteredContext();

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8context_in_context",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern int CefV8contextInContext();

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_undefined",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateUndefined();

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_null", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateNull();

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_bool", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateBool(int value);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_int", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateInt(int value);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_uint", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateUint(uint value);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_double",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateDouble(Double value);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_date", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateDate(IntPtr date);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_string",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateString(IntPtr value);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_object",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateObject(IntPtr accessor);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_array",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateArray(int length);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8value_create_function",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8valueCreateFunction(IntPtr name, IntPtr handler);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_v8stack_trace_get_current",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr CefV8stackTraceGetCurrent(int frameLimit);

        [DllImport(CefAssembly.Name, EntryPoint = "cef_register_extension", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode)]
    ...
    public static class CefV8CapiDelegates {
        public delegate IntPtr GetTaskRunnerCallback(IntPtr self);
        ...
        public delegate int IsSameCallback5(IntPtr self, IntPtr that);

        public delegate int EvalCallback(IntPtr self, IntPtr code, IntPtr retval, IntPtr exception);

        public delegate int ExecuteCallback2(
            IntPtr self, IntPtr name, IntPtr @object, int argumentscount, IntPtr arguments, IntPtr retval,
            IntPtr exception);

        public delegate int GetCallback(IntPtr self, IntPtr name, IntPtr @object, IntPtr retval, IntPtr exception);

        public delegate int SetCallback2(IntPtr self, IntPtr name, IntPtr @object, IntPtr value, IntPtr exception);
        ...
        public delegate int IsSameCallback6(IntPtr self, IntPtr that);
        ...
        public delegate int SetValueBykeyCallback(
            IntPtr self, IntPtr key, IntPtr value, CefV8Propertyattribute attribute);

        public delegate int SetValueByindexCallback(IntPtr self, int index, IntPtr value);

        public delegate int SetValueByaccessorCallback(
            IntPtr self, IntPtr key, CefV8Accesscontrol settings, CefV8Propertyattribute attribute);
        ...
        public delegate IntPtr ExecuteFunctionWithContextCallback(
            IntPtr self, IntPtr context, IntPtr @object, int argumentscount, IntPtr arguments);
