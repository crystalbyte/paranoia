...
namespace Crystalbyte.Paranoia.Cef {
    ...
    public static class CefStreamCapiDelegates {
        ...
        public delegate int MayBlockCallback(IntPtr self);
        ...
        public delegate int MayBlockCallback2(IntPtr self);
        ...
        public delegate int MayBlockCallback3(IntPtr self);
        ...
        public delegate int MayBlockCallback4(IntPtr self);
    }
}