...
namespace Crystalbyte.Paranoia.Cef {
    ...
    public static class CefMenuModelCapiDelegates {
        ...
        public delegate CefMenuItemType GetTypeCallback3(IntPtr self, int commandId);
        ...
        public delegate int SetAcceleratorCallback(
            IntPtr self, int commandId, int keyCode, int shiftPressed, int ctrlPressed, int altPressed);

        public delegate int SetAcceleratorAtCallback(
            IntPtr self, int index, int keyCode, int shiftPressed, int ctrlPressed, int altPressed);
        ...
        public delegate int GetAcceleratorCallback(
            IntPtr self, int commandId, ref int keyCode, ref int shiftPressed, ref int ctrlPressed, ref int altPressed);

        public delegate int GetAcceleratorAtCallback(
            IntPtr self, int index, ref int keyCode, ref int shiftPressed, ref int ctrlPressed, ref int altPressed);
    }
}