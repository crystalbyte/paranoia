...
namespace Crystalbyte.Paranoia.Cef {
    ...
    public static class CefValuesCapiDelegates {
        ...
        public delegate IntPtr CopyCallback5(IntPtr self);
        ...
        public delegate int IsValidCallback1012(IntPtr self);

        public delegate int IsOwnedCallback2(IntPtr self);

        public delegate int IsReadOnlyCallback9(IntPtr self);

        public delegate IntPtr CopyCallback6(IntPtr self, int excludeEmptyChildren);
        ...
        public delegate CefValueType GetTypeCallback5(IntPtr self, IntPtr key);
        ...
        public delegate int IsValidCallback101213(IntPtr self);

        public delegate int IsOwnedCallback3(IntPtr self);

        public delegate int IsReadOnlyCallback10(IntPtr self);

        public delegate IntPtr CopyCallback7(IntPtr self);
        ...
        public delegate CefValueType GetTypeCallback6(IntPtr self, int index);
