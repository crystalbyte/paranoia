...
namespace Crystalbyte.Paranoia.Cef {
    ...
    public static class CefXmlReaderCapi {
        [DllImport(CefAssembly.Name, EntryPoint = "cef_xml_reader_create", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode)]
        public static extern IntPtr CefXmlReaderCreate(IntPtr stream, CefXmlEncodingType encodingtype, IntPtr uri);
    }
    ...
    public static class CefXmlReaderCapiDelegates {
        ...
        public delegate CefXmlNodeType GetTypeCallback7(IntPtr self);
