...
namespace Crystalbyte.Paranoia.Mail.Mime.Decode {
    ...
    internal static class Rfc2822DateTime {
        ...
        /// <returns>
        ///     A valid <see cref="DateTime" /> object, which represents the same time as the string that was converted. If
        ///     <paramref
        ///         name="inputDate" />
        ///     is not a valid date representation, then <see cref="DateTime.MinValue" /> is returned.
        /// </returns>
