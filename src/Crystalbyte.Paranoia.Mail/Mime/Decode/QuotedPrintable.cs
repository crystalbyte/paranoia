...
namespace Crystalbyte.Paranoia.Mail.Mime.Decode {
    ...
    ///     <a
    ///         href="http://tools.ietf.org/html/rfc2047">
    ///         RFC 2047
    ///     </a>
    ///     .<br />
    ...
    internal static class QuotedPrintable {
        ...
        ///     If <see langword="true" /> , specifies that RFC 2047 quoted printable decoding is used. <br /> This is for
        ///     quoted-printable encoded words <br /> <br /> If
        ///     <see
        ///         langword="false" />
        ///     , specifies that RFC 2045 quoted printable decoding is used. <br /> This is for quoted-printable
        ...
        /// </summary>
        /// <param name="decode">
        ///     The string to decode which cannot have length above or equal to 3 and must start with an equal
        ///     sign.
        /// </param>
        ...
        ///     Thrown if a the
        ///     <paramref name="decode" />
        ///     parameter has length above 2 or does not start with an equal sign.
        /// </exception>
        ...
        ///     Thrown if a the
        ///     <paramref name="decode" />
        ///     parameter does not have length 3 or does not start with an equal sign.
        /// </exception>
