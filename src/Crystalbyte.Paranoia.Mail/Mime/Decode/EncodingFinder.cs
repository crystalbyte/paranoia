...
namespace Crystalbyte.Paranoia.Mail.Mime.Decode {
    ...
    ///         <item>
    ///             <description>
    ///                 If a mapping for the characterSet was added, use the specified Encoding from there. Mappings can be
    ///                 added using
    ///                 <see cref="AddMapping" />
    ///                 .
    ///             </description>
    ...
    public static class EncodingFinder {
        ...
        /// <param name="encoding">
        ///     The <see cref="Encoding" /> that should be mapped from <paramref name="characterSet" />
        /// </param>
        /// <exception cref="ArgumentNullException">
        ///     If
        ///     <paramref name="characterSet" />
