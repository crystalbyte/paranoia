...
namespace Crystalbyte.Paranoia.Mail.Mime.Traverse {
    /// <summary>
    ///     This is an abstract class which handles traversing of a <see cref="MailMessageReader" /> tree structure.<br />
    ...
    public abstract class AnswerMessageTraverser<TAnswer> : IAnswerMessageTraverser<TAnswer> {
        ...
        /// <summary>
        ///     For a concrete implementation, when a MultiPart <see cref="MessagePart" /> has fetched it's answers from it's
        ///     children, these
