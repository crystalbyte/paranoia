...
using System.Text;
using Crystalbyte.Paranoia.Mail.Common;
using Crystalbyte.Paranoia.Mail.Mime.Decode;
using Crystalbyte.Paranoia.Mail.Mime.Header;

#endregion

namespace Crystalbyte.Paranoia.Mail.Mime {
    /// <summary>
    ...
    ///     The root of the message tree is the <see cref="MailMessageReader" /> class.<br />
    ///     <br />
    ///     <b>Leafs</b>:<br />
    ...
    ///     - application/octet-stream MessagePart</code>
    ...
    public class MessagePart {
        ...
        ///     <br />
        ///     The <see cref="MessagePart" /> is a MultiPart message if the <see cref="ContentType" /> media type property starts
        ///     with "multipart/"
        /// </summary>
        ...
        ///     <br />
        ///     The FileName can be specified in the <see cref="ContentDisposition" /> or in the <see cref="ContentType" />
        ///     properties.<br />
        ...
        /// <returns>
        ///     The encoding specified by the <paramref name="characterSet" /> parameter, or ASCII if the character set was
        ///     <see
        ///         langword="null" />
        ///     or empty
        /// </returns>
        ...
        ///     <param name="stream">
        ///         The stream to find the next MultiPart boundary in. Do not use it for anything else then with
        ///         this method.
        ///     </param>
        ///     <param name="multiPartBoundary">
        ///         The MultiPart boundary to look for. This should be found in the
        ///         <see
        ///             cref="ContentType" />
        ///         header
        ///     </param>
        ///     <param name="lastMultipartBoundaryFound">
        ///         Is set to <see langword="true" /> if the next MultiPart boundary was indicated to be the last one, by having --
        ///         appended to it. Otherwise set to
        ///         <see
        ///             langword="false" />
        ///     </param>
        /// </summary>
        /// <returns>
        ///     The position of the first character of the line that contained MultiPartBoundary or -1 if no (more) MultiPart
        ...
        /// <returns>
        ///     A byte array which comes from the <paramref name="contentTransferEncoding" /> being used on the
        ///     <paramref
        ///         name="messageBody" />
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     If
        ///     <paramref name="messageBody" />
        ///     is
        ///     <see langword="null" />
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     Thrown if the
        ///     <paramref name="contentTransferEncoding" />
        ///     is unsupported
        /// </exception>
