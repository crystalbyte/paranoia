...
namespace Crystalbyte.Paranoia.Messaging.Common.Logging {
    /// <summary>
    ...
    public static class DefaultLogger {
        ...
        /// <exception cref="ArgumentNullException">Never set this to
        ///   <see langword="null" />
        ///   .
        ///   <br />
        ///   Instead you should implement a NullLogger which just does nothing.</exception>
