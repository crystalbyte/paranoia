...
namespace Crystalbyte.Paranoia.Messaging.Mime {
    ...
    public class Message {
        ...
        /// </summary>
        /// <returns> <see cref="MessagePart" /> which has a MediaType of text/plain or <see langword="null" /> if such <see
        ///    cref="MessagePart" /> could not be found. </returns>
        ...
        /// </summary>
        /// <returns> <see cref="MessagePart" /> which has a MediaType of text/html or <see langword="null" /> if such <see
        ///    cref="MessagePart" /> could not be found. </returns>
        ...
        ///   <see langword="null" />
        /// </exception>
        /// <exception cref="FileNotFoundException">If
        ///   <paramref name="file" />
