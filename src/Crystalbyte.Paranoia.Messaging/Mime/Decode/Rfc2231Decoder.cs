...
using Crystalbyte.Paranoia.Messaging.Common.Logging;
...
namespace Crystalbyte.Paranoia.Messaging.Mime.Decode {
    ...
    ///       <br />
    ///       From:
    ///       <c>Content-Type: text/html; boundary="someVeryLongStringHereWhichCouldBeWrappedInTransit"</c>
    ///       <br />
    ///       To:
    ...
    ///       <br />
    ///       From:
    ///       <c>Content-Disposition attachment; filename="specialCharsÆØÅ"</c>
    ///       <br />
    ///       To:
    ///       <c>Content-Disposition attachment; filename*="ISO-8859-1'en-us'specialCharsC6D8C0"</c>
    ///       <br />
    ///       This encoding is almost the same as
    ///       <see cref="EncodedWord" />
    ///       encoding, and is used to decode the value.
    ///       <br />
    ///     </item>
    ///     <item>
    ///       <b>Continuation and Encoding</b>
    ///       <br />
    ...
    ///       <br />
    ///       From:
    ///       <c>Content-Disposition attachment; filename="specialCharsÆØÅWhichIsSoLong"</c>
    ///       <br />
    ///       To:
    ///       <c>Content-Disposition attachment; filename*0*="ISO-8859-1'en-us'specialCharsC6D8C0"; filename*1*="WhichIsSoLong"</c>
    ///       <br />
    ...
    internal static class Rfc2231Decoder {
            ...
            foreach (var part in splitted) {
                ...
                if (keyValue.Length == 1) {
                    ...
                    throw new ArgumentException("When splitting the part \"" + part + "\" by = there was " +
                                                keyValue.Length + " parts. Only 1 and 2 are supported");
                }
            }
        ...
        /// </summary>
        /// <param name="encodingUsed"> The encoding used to decode with - it is given back for later use. <br /> <see
        ///    langword="null" /> if input was not in the correct form. </param>
        /// <param name="toDecode"> The value to decode </param>
        /// <returns> The decoded value that corresponds to <paramref name="toDecode" /> or if <paramref name="toDecode" /> is not on the correct form, it will be non-decoded. </returns>
        /// <exception cref="ArgumentNullException">If
        ///   <paramref name="toDecode" />
        ///   is
        ///   <see langword="null" />
