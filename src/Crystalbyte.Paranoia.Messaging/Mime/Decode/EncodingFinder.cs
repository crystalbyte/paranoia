...
namespace Crystalbyte.Paranoia.Messaging.Mime.Decode {
    ...
    ///   <list type="number">
    ///     <item>
    ///       <description>If a mapping for the characterSet was added, use the specified Encoding from there. Mappings can be added using
    ///         <see cref="AddMapping" />
    ///         .</description>
    ///     </item>
    ///     <item>
    ///       <description>Try to parse the characterSet and look it up using
    ///         <see cref="Encoding.GetEncoding(int)" />
    ///         for codepages or
    ///         <see cref="Encoding.GetEncoding(string)" />
    ///         for named encodings.</description>
    ///     </item>
    ///     <item>
    ///       <description>If an encoding is not found yet, use the
    ///         <see cref="FallbackDecoder" />
    ///         if defined. The
    ///         <see cref="FallbackDecoder" />
    ///         is user defined.</description>
    ///     </item>
    ///   </list>
    /// </summary>
