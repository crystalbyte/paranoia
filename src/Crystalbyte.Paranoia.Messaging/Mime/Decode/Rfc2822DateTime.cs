...
namespace Crystalbyte.Paranoia.Messaging.Mime.Decode {
    ...
    internal static class Rfc2822DateTime {
        ...
        /// <returns> A valid <see cref="DateTime" /> object, which represents the same time as the string that was converted. If <paramref
        ///    name="inputDate" /> is not a valid date representation, then <see cref="DateTime.MinValue" /> is returned. </returns>
        /// <exception cref="ArgumentNullException">If
        ///   <paramref name="inputDate" />
        ///   is
        ///   <see langword="null" />
        /// </exception>
        /// <exception cref="ArgumentException">If the
        ///   <paramref name="inputDate" />
        ///   could not be parsed into a
        ///   <see cref="DateTime" />
        ///   object</exception>
        ...
        /// <summary>
        ///   Adjust the <paramref name="dateTime" /> object given according to the timezone specified in the <paramref
        ///    name="dateInput" />.
        /// </summary>
        ...
        /// <exception cref="ArgumentException">If no timezone was found in
        ...
        ///   and
        ///   <paramref name="dateInput" />
        ///   does not agree on the day</exception>
