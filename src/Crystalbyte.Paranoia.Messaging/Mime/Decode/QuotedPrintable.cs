...
namespace Crystalbyte.Paranoia.Messaging.Mime.Decode {
    /// <summary>
    ///   Used for decoding Quoted-Printable text.<br />
    ///   This is a robust implementation of a Quoted-Printable decoder defined in <a href="http://tools.ietf.org/html/rfc2045">RFC 2045</a> and <a
    ///    href="http://tools.ietf.org/html/rfc2047">RFC 2047</a>.<br />
    ...
    internal static class QuotedPrintable {
        ...
        /// <param name="encodedWordVariant"> If <see langword="true" /> , specifies that RFC 2047 quoted printable decoding is used. <br /> This is for quoted-printable encoded words <br /> <br /> If <see
        ///    langword="false" /> , specifies that RFC 2045 quoted printable decoding is used. <br /> This is for quoted-printable Content-Transfer-Encoding </param>
        ...
        /// </exception>
        /// <remarks>
        ///   See <a href="http://tools.ietf.org/html/rfc2047#section-4.2">RFC 2047 section 4.2</a> for RFC details
        /// </remarks>
        ...
        ///   <code>Control characters other than TAB, or CR and LF as parts of CRLF pairs,
        ...
        ///     the user that illegal characters were discovered.</code>
        ...
        ///   <code>An "=" cannot be the ultimate or penultimate character in an encoded
        ///     object. This could be handled as in case (2) above.</code>
        ///   Case (2) is:<br />
        ///   <code>An "=" followed by a character that is neither a
        ...
        ///     this point in the data.</code>
        /// </summary>
        /// <param name="decode"> The string to decode which cannot have length above or equal to 3 and must start with an equal sign. </param>
        /// <returns> A decoded byte array </returns>
        /// <exception cref="ArgumentNullException">If
        ///   <paramref name="decode" />
        ///   is
        ///   <see langword="null" />
        /// </exception>
        /// <exception cref="ArgumentException">Thrown if a the
        ///   <paramref name="decode" />
        ///   parameter has length above 2 or does not start with an equal sign.</exception>
        ...
        /// <exception cref="ArgumentException">Thrown if a the
        ///   <paramref name="decode" />
        ///   parameter does not have length 3 or does not start with an equal sign.</exception>
