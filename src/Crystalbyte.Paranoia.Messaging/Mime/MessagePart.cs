...
using System.Text;
using Crystalbyte.Paranoia.Messaging.Common;
using Crystalbyte.Paranoia.Messaging.Mime.Decode;
...
namespace Crystalbyte.Paranoia.Messaging.Mime {
    ...
    public class MessagePart {
        ...
        /// <returns> The encoding specified by the <paramref name="characterSet" /> parameter, or ASCII if the character set was <see
        ...
        ///   <param name="multiPartBoundary"> The MultiPart boundary to look for. This should be found in the <see
        ///    cref="ContentType" /> header </param>
        ///   <param name="lastMultipartBoundaryFound"> Is set to <see langword="true" /> if the next MultiPart boundary was indicated to be the last one, by having -- appended to it. Otherwise set to <see
        ...
        /// <returns> A byte array which comes from the <paramref name="contentTransferEncoding" /> being used on the <paramref
        ///    name="messageBody" /> </returns>
        /// <exception cref="ArgumentNullException">If
        ...
        ///   <see langword="null" />
        /// </exception>
        /// <exception>Other exceptions relevant to using a
        ///   <see cref="FileStream" />
