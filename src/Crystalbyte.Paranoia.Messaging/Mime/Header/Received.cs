...
namespace Crystalbyte.Paranoia.Messaging.Mime.Header {
    /// <summary>
    ...
    public class Received {
        ...
        ///   <code>from sending.com (localMachine [127.0.0.1]) by test.net (Postfix)</code>
        ...
        public Received(string headerValue) {
            ...
            if (headerValue.Contains(";")) {
                var datePart = headerValue.Substring(headerValue.LastIndexOf(";") + 1);
