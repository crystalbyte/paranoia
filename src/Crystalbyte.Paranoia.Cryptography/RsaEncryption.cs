...
//            [DllImport(Sodium.Library, EntryPoint = "BIO_new")]
//            public static extern IntPtr BIO_new(IntPtr type);

//            [DllImport(Sodium.Library, EntryPoint = "BIO_s_mem")]
//            public static extern IntPtr BIO_s_mem();

//            [DllImport(Sodium.Library, EntryPoint = "BIO_Free")]
//            public static extern void BIO_Free(IntPtr bio);

//            [DllImport(Sodium.Library, EntryPoint = "BIO_set_fp")]
//            public static extern void BIO_set_fp(IntPtr bio,IntPtr fp, int flags);

//            [DllImport(Sodium.Library, EntryPoint = "BIO_new_mem_buf")]
...
//            [DllImport(Sodium.Library, EntryPoint = "EVP_aes_256_cbc")]
//            public static extern IntPtr EVP_aes_256_cbc();

//            [DllImport(Sodium.Library, EntryPoint = "EVP_PKEY_assign_RSA")]
//            public static extern int EVP_PKEY_assign_RSA(IntPtr pkey, IntPtr keypair);

//            [DllImport(Sodium.Library, EntryPoint = "EVP_PKEY_new")]
//            public static extern IntPtr EVP_PKEY_new();

//            // PEM

//            [DllImport(Sodium.Library, EntryPoint = "PEM_ASN1_write_bio")]
